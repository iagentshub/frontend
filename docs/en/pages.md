...
| **Profile** | User settings: visual theme and password. Includes a **Groups** tab to create collaboration teams, manage members, send invitations, and view resources shared with each team. Guests cannot create or join groups. |
