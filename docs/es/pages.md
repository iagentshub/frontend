...
| **Perfil** | Ajustes del usuario: tema visual y contraseña. Incluye la pestaña **Grupos** para crear equipos de colaboración, gestionar miembros, enviar invitaciones y ver los recursos compartidos con cada equipo. Los invitados no pueden crear ni unirse a grupos. |
